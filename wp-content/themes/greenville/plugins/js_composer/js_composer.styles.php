...
if ( !function_exists( 'greenville_vc_get_css' ) ) {
	add_filter( 'greenville_filter_get_css', 'greenville_vc_get_css', 10, 4 );
	function greenville_vc_get_css($css, $colors, $fonts, $scheme='') {
