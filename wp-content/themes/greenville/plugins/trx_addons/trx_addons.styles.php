...
if (!function_exists('greenville_trx_addons_get_css')) {
	add_filter('greenville_filter_get_css', 'greenville_trx_addons_get_css', 10, 4);
	function greenville_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
/* Iconed text */
.sc_layouts_iconed_text .sc_layouts_iconed_text_link:hover .sc_layouts_iconed_text_details span,
.scheme_self.sc_layouts_iconed_text .sc_layouts_iconed_text_link:hover .sc_layouts_iconed_text_details span  {
	color: {$colors['text_link']};
}
...
.sc_layouts_menu_nav > li li.sfHover > a, .sc_layouts_menu_nav .sub-menu li.current-menu-item a {
	color: {$colors['inverse_link']} !important;
...
.sc_countdown_circle .sc_countdown_digits {
	color: {$colors['alter_link']};
	border-color: {$colors['alter_bg_hover_01']};
...
.scheme_self.sc_googlemap_content {
	color: {$colors['text']};
	background-color: {$colors['alter_bd_color_09']};
}
...
.sc_price_info .sc_price_title, .sc_price_info .sc_price_title a {
	color: {$colors['inverse_link']};
}
